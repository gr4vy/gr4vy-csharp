...
<!-- UsageSnippet language="csharp" operationID="list_transaction_actions" method="get" path="/transactions/{transaction_id}/actions" -->
```csharp
using Gr4vy;
...
**[TransactionActions](../../Models/Components/TransactionActions.md)**
