...
<!-- UsageSnippet language="csharp" operationID="list_transaction_captures" method="get" path="/transactions/{transaction_id}/captures" -->
```csharp
using Gr4vy;
...
**[CaptureCollection](../../Models/Components/CaptureCollection.md)**
...
<!-- UsageSnippet language="csharp" operationID="get_transaction_capture" method="get" path="/transactions/{transaction_id}/captures/{capture_id}" -->
```csharp
using Gr4vy;
using Gr4vy.Models.Components;
...
**[Capture](../../Models/Components/Capture.md)**
