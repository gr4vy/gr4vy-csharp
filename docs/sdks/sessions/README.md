...
<!-- UsageSnippet language="csharp" operationID="complete_paze_mobile_session" method="post" path="/digital-wallets/paze/session/complete" -->
```csharp
using Gr4vy;
using Gr4vy.Models.Components;
...
**[PazeSessionComplete](../../Models/Components/PazeSessionComplete.md)**
