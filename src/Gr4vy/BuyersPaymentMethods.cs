...
namespace Gr4vy
{
    ...
    public interface IBuyersPaymentMethods
    {
        ...
        /// </remarks>
        /// <param name="request">A <see cref="ListBuyerPaymentMethodsRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="PaymentMethodSummaries"/> object when completed.</returns>
        ...
        public  Task<PaymentMethodSummaries> ListAsync(
            ListBuyerPaymentMethodsRequest? request = null,
    ...
    public class BuyersPaymentMethods: IBuyersPaymentMethods
    {
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<PaymentMethodSummaries> ListAsync(
            ListBuyerPaymentMethodsRequest? request = null,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/buyers/payment-methods", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "list_buyer_payment_methods", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<PaymentMethodSummaries>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into PaymentMethodSummaries.", httpResponse, httpResponseBody, ex);
                    }
