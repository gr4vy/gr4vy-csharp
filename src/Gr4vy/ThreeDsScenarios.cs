...
namespace Gr4vy
{
    ...
    public interface IThreeDsScenarios
    {
        /// <summary>
        ...
        /// </remarks>
        /// <param name="threeDSecureScenarioCreate">A <see cref="ThreeDSecureScenarioCreate"/> parameter.</param>
        /// <param name="merchantAccountId">The ID of the merchant account to use for this request.</param>
        /// <returns>An awaitable task that returns a <see cref="ThreeDSecureScenario"/> object when completed.</returns>
        /// <exception cref="ArgumentNullException">The required parameter <paramref name="threeDSecureScenarioCreate"/> is null.</exception>
        ...
        public  Task<ThreeDSecureScenario> CreateAsync(
        ...
        /// <returns>An awaitable task that returns a <see cref="GetThreeDsScenarioResponse"/> object when completed.</returns>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="Error400">The request was invalid. Thrown when the API returns a 400 response.</exception>
        /// <exception cref="Error401">The request was unauthorized. Thrown when the API returns a 401 response.</exception>
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<GetThreeDsScenarioResponse> ListAsync(
            string? cursor = null,
            long? limit = 20,
            string? merchantAccountId = null,
        ...
        /// </remarks>
        /// <param name="threeDsScenarioId">The ID of the 3DS scenario.</param>
        /// <param name="threeDSecureScenarioUpdate">A <see cref="ThreeDSecureScenarioUpdate"/> parameter.</param>
        /// <param name="merchantAccountId">The ID of the merchant account to use for this request.</param>
        /// <returns>An awaitable task that returns a <see cref="ThreeDSecureScenario"/> object when completed.</returns>
        /// <exception cref="ArgumentNullException">One of <paramref name="threeDsScenarioId"/> or <paramref name="threeDSecureScenarioUpdate"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="Error400">The request was invalid. Thrown when the API returns a 400 response.</exception>
        /// <exception cref="Error401">The request was unauthorized. Thrown when the API returns a 401 response.</exception>
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<ThreeDSecureScenario> UpdateAsync(
        ...
        /// <exception cref="ArgumentNullException">The required parameter <paramref name="threeDsScenarioId"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="Error400">The request was invalid. Thrown when the API returns a 400 response.</exception>
        /// <exception cref="Error401">The request was unauthorized. Thrown when the API returns a 401 response.</exception>
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task DeleteAsync(string threeDsScenarioId, string? merchantAccountId = null);
    }

    public class ThreeDsScenarios: IThreeDsScenarios
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        public ThreeDsScenarios(SDKConfig config)
        {
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<ThreeDSecureScenario> CreateAsync(
            ThreeDSecureScenarioCreate threeDSecureScenarioCreate,
            string? merchantAccountId = null
        )
        {
            if (threeDSecureScenarioCreate == null) throw new ArgumentNullException(nameof(threeDSecureScenarioCreate));

            var request = new CreateThreeDsScenarioRequest()
            {
                ThreeDSecureScenarioCreate = threeDSecureScenarioCreate,
            ...
            var urlString = baseUrl + "/three-ds-scenarios";
            ...
            var serializedBody = RequestBodySerializer.Serialize(request, "ThreeDSecureScenarioCreate", "json", false, false);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "create_three_ds_scenario", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 201)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<ThreeDSecureScenario>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into ThreeDSecureScenario.", httpResponse, httpResponseBody, ex);
                    }
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<GetThreeDsScenarioResponse> ListAsync(
            string? cursor = null,
            long? limit = 20,
            string? merchantAccountId = null,
            RetryConfig? retryConfig = null
        ...
        {
            var request = new GetThreeDsScenarioRequest()
            {
                Cursor = cursor,
                Limit = limit,
                MerchantAccountId = merchantAccountId,
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/three-ds-scenarios", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "get_three_ds_scenario", null, SDKConfiguration.SecuritySource);
            ...
            Func<Task<GetThreeDsScenarioResponse?>> nextFunc = async delegate()
            {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<ThreeDSecureScenarios>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into ThreeDSecureScenarios.", httpResponse, httpResponseBody, ex);
                    }

                    var result = obj!;
                    var response = new GetThreeDsScenarioResponse()
                    {
                        Result = result,
                        Next = nextFunc
                    };
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<ThreeDSecureScenario> UpdateAsync(
            string threeDsScenarioId,
            ThreeDSecureScenarioUpdate threeDSecureScenarioUpdate,
            string? merchantAccountId = null
        )
        {
            if (threeDsScenarioId == null) throw new ArgumentNullException(nameof(threeDsScenarioId));
            if (threeDSecureScenarioUpdate == null) throw new ArgumentNullException(nameof(threeDSecureScenarioUpdate));

            var request = new UpdateThreeDsScenarioRequest()
            {
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/three-ds-scenarios/{three_ds_scenario_id}", request, null);
            ...
            var serializedBody = RequestBodySerializer.Serialize(request, "ThreeDSecureScenarioUpdate", "json", false, false);
            if (serializedBody != null)
            {
                httpRequest.Content = serializedBody;
            }
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "update_three_ds_scenario", null, SDKConfiguration.SecuritySource);
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task DeleteAsync(string threeDsScenarioId, string? merchantAccountId = null)
        {
            if (threeDsScenarioId == null) throw new ArgumentNullException(nameof(threeDsScenarioId));

            var request = new DeleteThreeDsScenarioRequest()
            {
                ThreeDsScenarioId = threeDsScenarioId,
                MerchantAccountId = merchantAccountId,
            };
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "delete_three_ds_scenario", null, SDKConfiguration.SecuritySource);
