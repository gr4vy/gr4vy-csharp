...
namespace Gr4vy
{
    ...
    public interface IDigitalWallets
    {
        ...
        /// </remarks>
        /// <param name="digitalWalletCreate">A <see cref="DigitalWalletCreate"/> parameter.</param>
        /// <param name="merchantAccountId">The ID of the merchant account to use for this request.</param>
        /// <returns>An awaitable task that returns a <see cref="DigitalWallet"/> object when completed.</returns>
        /// <exception cref="ArgumentNullException">The required parameter <paramref name="digitalWalletCreate"/> is null.</exception>
        ...
        public  Task<DigitalWallet> CreateAsync(
        ...
        /// <returns>An awaitable task that returns a <see cref="Models.Components.DigitalWallets"/> object when completed.</returns>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="Error400">The request was invalid. Thrown when the API returns a 400 response.</exception>
        /// <exception cref="Error401">The request was unauthorized. Thrown when the API returns a 401 response.</exception>
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<Models.Components.DigitalWallets> ListAsync(
            string? merchantAccountId = null,
        ...
        /// </remarks>
        /// <param name="digitalWalletId">The ID of the digital wallet to read.</param>
        /// <param name="merchantAccountId">The ID of the merchant account to use for this request.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="DigitalWallet"/> object when completed.</returns>
        /// <exception cref="ArgumentNullException">The required parameter <paramref name="digitalWalletId"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="Error400">The request was invalid. Thrown when the API returns a 400 response.</exception>
        /// <exception cref="Error401">The request was unauthorized. Thrown when the API returns a 401 response.</exception>
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<DigitalWallet> GetAsync(
        ...
        /// </remarks>
        /// <param name="digitalWalletId">The ID of the digital wallet to delete.</param>
        /// <param name="merchantAccountId">The ID of the merchant account to use for this request.</param>
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task DeleteAsync(string digitalWalletId, string? merchantAccountId = null);
        ...
        /// </remarks>
        /// <param name="digitalWalletId">The ID of the digital wallet to edit.</param>
        /// <param name="digitalWalletUpdate">A <see cref="DigitalWalletUpdate"/> parameter.</param>
        /// <param name="merchantAccountId">The ID of the merchant account to use for this request.</param>
        /// <returns>An awaitable task that returns a <see cref="DigitalWallet"/> object when completed.</returns>
        /// <exception cref="ArgumentNullException">One of <paramref name="digitalWalletId"/> or <paramref name="digitalWalletUpdate"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="Error400">The request was invalid. Thrown when the API returns a 400 response.</exception>
        /// <exception cref="Error401">The request was unauthorized. Thrown when the API returns a 401 response.</exception>
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<DigitalWallet> UpdateAsync(
            string digitalWalletId,
    ...
    public class DigitalWallets: IDigitalWallets
    {
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<DigitalWallet> CreateAsync(
            DigitalWalletCreate digitalWalletCreate,
            string? merchantAccountId = null
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "configure_digital_wallet", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 201)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<DigitalWallet>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into DigitalWallet.", httpResponse, httpResponseBody, ex);
                    }
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<Models.Components.DigitalWallets> ListAsync(
            string? merchantAccountId = null,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "list_digital_wallets", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var httpResponseBody = await httpResponse.Content.ReadAsStringAsync();
                    Models.Components.DigitalWallets obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<Models.Components.DigitalWallets>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into Models.Components.DigitalWallets.", httpResponse, httpResponseBody, ex);
                    }
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<DigitalWallet> GetAsync(
            string digitalWalletId,
            string? merchantAccountId = null,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "get_digital_wallet", null, SDKConfiguration.SecuritySource);
        ...
        public async  Task DeleteAsync(string digitalWalletId, string? merchantAccountId = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "delete_digital_wallet", null, SDKConfiguration.SecuritySource);
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<DigitalWallet> UpdateAsync(
            string digitalWalletId,
            DigitalWalletUpdate digitalWalletUpdate,
            string? merchantAccountId = null
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "update_digital_wallet", null, SDKConfiguration.SecuritySource);
