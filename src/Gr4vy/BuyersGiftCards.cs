...
namespace Gr4vy
{
    ...
    public class BuyersGiftCards: IBuyersGiftCards
    {
        ...
        public async Task<GiftCardSummaries> ListAsync(string? buyerExternalIdentifier = null, string? buyerId = null, string? merchantAccountId = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "list_buyer_gift_cards", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GiftCardSummaries>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
