...
namespace Gr4vy
{
    ...
    public class Refunds: IRefunds
    {
        ...
        public async Task<Refund> GetAsync(string refundId, string? merchantAccountId = null, RetryConfig? retryConfig = null)
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/refunds/{refund_id}", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "get_refund", new List<string> {  }, SDKConfiguration.SecuritySource);
