...
namespace Gr4vy
{
    ...
    public interface IActions
    {
        ...
        /// <returns>An awaitable task that returns a <see cref="TransactionActions"/> object when completed.</returns>
        ...
        public  Task<TransactionActions> ListAsync(
    ...
    public class Actions: IActions
    {
        ...
        public Actions(SDKConfig config)
        {
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<TransactionActions> ListAsync(
            string transactionId,
            string? merchantAccountId = null,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/transactions/{transaction_id}/actions", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "list_transaction_actions", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    TransactionActions obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<TransactionActions>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into TransactionActions.", httpResponse, httpResponseBody, ex);
                    }
