...
namespace Gr4vy
{
    ...
    public class GiftCards: IGiftCards
    {
        ...
        public async Task<GiftCard> GetAsync(string giftCardId, string? merchantAccountId = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "get_gift_card", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task DeleteAsync(string giftCardId, string? merchantAccountId = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "delete_gift_card", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task<GiftCard> CreateAsync(GiftCardCreate giftCardCreate, string? merchantAccountId = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "create_gift_card", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task<ListGiftCardsResponse> ListAsync(ListGiftCardsRequest? request = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "list_gift_cards", new List<string> {  }, SDKConfiguration.SecuritySource);
