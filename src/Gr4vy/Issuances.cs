...
namespace Gr4vy
{
    ...
    public interface IIssuances
    {
        ...
        /// </remarks>
        /// <param name="giftCardIssuanceCreate">A <see cref="GiftCardIssuanceCreate"/> parameter.</param>
        /// <param name="idempotencyKey">A unique key forwarded to the gift card service to make the issuance idempotent.</param>
        /// <param name="merchantAccountId">The ID of the merchant account to use for this request.</param>
        /// <returns>An awaitable task that returns a <see cref="GiftCardIssuance"/> object when completed.</returns>
        /// <exception cref="ArgumentNullException">The required parameter <paramref name="giftCardIssuanceCreate"/> is null.</exception>
        ...
        public  Task<GiftCardIssuance> CreateAsync(
    ...
    public class Issuances: IIssuances
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        public Issuances(SDKConfig config)
        {
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<GiftCardIssuance> CreateAsync(
            GiftCardIssuanceCreate giftCardIssuanceCreate,
            string? idempotencyKey = null,
            string? merchantAccountId = null
        )
        {
            if (giftCardIssuanceCreate == null) throw new ArgumentNullException(nameof(giftCardIssuanceCreate));
            ...
            var urlString = baseUrl + "/gift-cards/issuances";
            ...
            var serializedBody = RequestBodySerializer.Serialize(request, "GiftCardIssuanceCreate", "json", false, false);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "issue_gift_card", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 201)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    GiftCardIssuance obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GiftCardIssuance>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GiftCardIssuance.", httpResponse, httpResponseBody, ex);
                    }
