...
namespace Gr4vy
{
    ...
    public interface ITransactionsRefunds
    {
        ...
        public  Task<Models.Components.Refunds> ListAsync(
        ...
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="Refund"/> object when completed.</returns>
        /// <exception cref="ArgumentNullException">One of <paramref name="transactionId"/> or <paramref name="refundId"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="Error400">The request was invalid. Thrown when the API returns a 400 response.</exception>
        /// <exception cref="Error401">The request was unauthorized. Thrown when the API returns a 401 response.</exception>
    ...
    public class TransactionsRefunds: ITransactionsRefunds
    {
        ...
        public TransactionsRefunds(SDKConfig config)
        {
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<Models.Components.Refunds> ListAsync(
            string transactionId,
            string? merchantAccountId = null,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/transactions/{transaction_id}/refunds", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "list_transaction_refunds", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    Models.Components.Refunds obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<Models.Components.Refunds>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into Models.Components.Refunds.", httpResponse, httpResponseBody, ex);
                    }
        ...
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "create_transaction_refund", null, SDKConfiguration.SecuritySource);
        ...
        )
        {
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/transactions/{transaction_id}/refunds/{refund_id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "get_transaction_refund", null, SDKConfiguration.SecuritySource);
