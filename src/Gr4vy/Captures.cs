...
namespace Gr4vy
{
    ...
    public interface ICaptures
    {
        ...
        /// <returns>An awaitable task that returns a <see cref="CaptureCollection"/> object when completed.</returns>
        ...
        public  Task<CaptureCollection> ListAsync(
        ...
        /// <param name="merchantAccountId">The ID of the merchant account to use for this request.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="Capture"/> object when completed.</returns>
        /// <exception cref="ArgumentNullException">One of <paramref name="transactionId"/> or <paramref name="captureId"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="Error400">The request was invalid. Thrown when the API returns a 400 response.</exception>
        /// <exception cref="Error401">The request was unauthorized. Thrown when the API returns a 401 response.</exception>
    ...
    public class Captures: ICaptures
    {
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<CaptureCollection> ListAsync(
            string transactionId,
            string? merchantAccountId = null,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var request = new ListTransactionCapturesRequest()
            {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/transactions/{transaction_id}/captures", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "list_transaction_captures", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    CaptureCollection obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<CaptureCollection>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into CaptureCollection.", httpResponse, httpResponseBody, ex);
                    }
        ...
        {
            if (transactionId == null) throw new ArgumentNullException(nameof(transactionId));
            if (captureId == null) throw new ArgumentNullException(nameof(captureId));

            var request = new GetTransactionCaptureRequest()
            {
                TransactionId = transactionId,
                CaptureId = captureId,
                MerchantAccountId = merchantAccountId,
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/transactions/{transaction_id}/captures/{capture_id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "get_transaction_capture", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<Capture>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into Capture.", httpResponse, httpResponseBody, ex);
                    }
