...
namespace Gr4vy
{
    ...
    public interface IRefundSettlements
    {
        /// <summary>
        ...
        /// <param name="settlementId">The unique identifier of the refund settlement.</param>
        /// <param name="merchantAccountId">The ID of the merchant account to use for this request.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>A settlement record for a refund on a transaction.</returns>
        ...
        public  Task<RefundSettlement> GetAsync(
        ...
        /// <param name="merchantAccountId">The ID of the merchant account to use for this request.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>A list of settlement records for the refunds on a transaction.</returns>
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<Models.Components.RefundSettlements> ListAsync(
            string transactionId,
            string? merchantAccountId = null,
            RetryConfig? retryConfig = null
        );
    ...
    public class RefundSettlements: IRefundSettlements
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        public RefundSettlements(SDKConfig config)
        {
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<RefundSettlement> GetAsync(
            string transactionId,
            string settlementId,
            string? merchantAccountId = null,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var request = new GetTransactionRefundSettlementRequest()
            {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/transactions/{transaction_id}/refund-settlements/{settlement_id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "get_transaction_refund_settlement", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    RefundSettlement obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<RefundSettlement>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into RefundSettlement.", httpResponse, httpResponseBody, ex);
                    }
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<Models.Components.RefundSettlements> ListAsync(
            string transactionId,
            string? merchantAccountId = null,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var request = new ListTransactionRefundSettlementsRequest()
            {
                TransactionId = transactionId,
                MerchantAccountId = merchantAccountId,
            };
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/transactions/{transaction_id}/refund-settlements", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "list_transaction_refund_settlements", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var httpResponseBody = await httpResponse.Content.ReadAsStringAsync();
                    Models.Components.RefundSettlements obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<Models.Components.RefundSettlements>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into Models.Components.RefundSettlements.", httpResponse, httpResponseBody, ex);
                    }
