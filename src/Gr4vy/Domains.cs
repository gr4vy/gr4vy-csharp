...
namespace Gr4vy
{
    ...
    public class Domains: IDomains
    {
        ...
        public Domains(ISpeakeasyHttpClient client, Func<Gr4vy.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<object> CreateAsync(string digitalWalletId, DigitalWalletDomain digitalWalletDomain, double? timeoutInSeconds = 1D, string? merchantAccountId = null)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "register_digital_wallet_domain", new List<string> {  }, _securitySource);
        ...
        public async Task<object> DeleteAsync(string digitalWalletId, DigitalWalletDomain digitalWalletDomain, double? timeoutInSeconds = 1D, string? merchantAccountId = null)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "unregister_digital_wallet_domain", new List<string> {  }, _securitySource);
