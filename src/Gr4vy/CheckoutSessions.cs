...
namespace Gr4vy
{
    ...
    public interface ICheckoutSessions
    {
        ...
        /// <param name="checkoutSessionCreate">A <see cref="CheckoutSessionCreate"/> parameter.</param>
        /// <returns>An awaitable task that returns a <see cref="CheckoutSession"/> object when completed.</returns>
        ...
        public  Task<CheckoutSession> CreateAsync(
            string? merchantAccountId = null,
            CheckoutSessionCreate? checkoutSessionCreate = null
        );
        ...
        /// <param name="merchantAccountId">The ID of the merchant account to use for this request.</param>
        /// <returns>An awaitable task that returns a <see cref="CheckoutSession"/> object when completed.</returns>
        /// <exception cref="ArgumentNullException">One of <paramref name="sessionId"/> or <paramref name="checkoutSessionCreate"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="Error400">The request was invalid. Thrown when the API returns a 400 response.</exception>
        /// <exception cref="Error401">The request was unauthorized. Thrown when the API returns a 401 response.</exception>
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<CheckoutSession> UpdateAsync(
            string sessionId,
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<CheckoutSession> GetAsync(
            string sessionId,
            string? merchantAccountId = null,
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task DeleteAsync(string sessionId, string? merchantAccountId = null);
    }
    ...
    public class CheckoutSessions: ICheckoutSessions
    {
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<CheckoutSession> CreateAsync(
            string? merchantAccountId = null,
            CheckoutSessionCreate? checkoutSessionCreate = null
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "create_checkout_session", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 201)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<CheckoutSession>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into CheckoutSession.", httpResponse, httpResponseBody, ex);
                    }
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<CheckoutSession> UpdateAsync(
            string sessionId,
            CheckoutSessionCreate checkoutSessionCreate,
            string? merchantAccountId = null
        )
        {
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/checkout/sessions/{session_id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "update_checkout_session", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<CheckoutSession>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into CheckoutSession.", httpResponse, httpResponseBody, ex);
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<CheckoutSession> GetAsync(
            string sessionId,
            string? merchantAccountId = null,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "get_checkout_session", null, SDKConfiguration.SecuritySource);
        ...
        public async  Task DeleteAsync(string sessionId, string? merchantAccountId = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "delete_checkout_session", null, SDKConfiguration.SecuritySource);
