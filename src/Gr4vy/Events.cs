...
namespace Gr4vy
{
    ...
    public interface IEvents
    {
        ...
        /// <returns>An awaitable task that returns a <see cref="ListTransactionEventsResponse"/> object when completed.</returns>
        ...
        public  Task<ListTransactionEventsResponse> ListAsync(
    ...
    public class Events: IEvents
    {
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<ListTransactionEventsResponse> ListAsync(
            string transactionId,
            string? cursor = null,
            long? limit = 100,
            string? merchantAccountId = null,
        ...
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/transactions/{transaction_id}/events", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "list_transaction_events", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<TransactionEvents>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
