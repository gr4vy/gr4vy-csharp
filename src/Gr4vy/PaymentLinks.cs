...
namespace Gr4vy
{
    ...
    public interface IPaymentLinks
    {
        ...
        /// </remarks>
        /// </summary>
        Task<PaymentLink> CreateAsync(PaymentLinkCreate paymentLinkCreate, string? merchantAccountId = null);
        ...
        /// </remarks>
        /// </summary>
        Task ExpireAsync(string paymentLinkId, string? merchantAccountId = null);
        ...
        /// </remarks>
        /// </summary>
        Task<PaymentLink> GetAsync(string paymentLinkId, string? merchantAccountId = null, RetryConfig? retryConfig = null);
    }
    ...
    public class PaymentLinks: IPaymentLinks
    {
        ...
        public async Task<PaymentLink> CreateAsync(PaymentLinkCreate paymentLinkCreate, string? merchantAccountId = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "add_payment_link", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task<ListPaymentLinksResponse> ListAsync(string? cursor = null, long? limit = 20, List<string>? buyerSearch = null, string? merchantAccountId = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "list_payment_links", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task ExpireAsync(string paymentLinkId, string? merchantAccountId = null)
        {
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/payment-links/{payment_link_id}/expire", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "expire_payment_link", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task<PaymentLink> GetAsync(string paymentLinkId, string? merchantAccountId = null, RetryConfig? retryConfig = null)
        {
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/payment-links/{payment_link_id}", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "get_payment_link", new List<string> {  }, SDKConfiguration.SecuritySource);
