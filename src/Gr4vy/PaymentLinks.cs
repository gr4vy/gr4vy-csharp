...
namespace Gr4vy
{
    ...
    public interface IPaymentLinks
    {
        ...
        /// </remarks>
        /// <param name="paymentLinkCreate">A <see cref="PaymentLinkCreate"/> parameter.</param>
        /// <param name="merchantAccountId">The ID of the merchant account to use for this request.</param>
        /// <returns>An awaitable task that returns a <see cref="PaymentLink"/> object when completed.</returns>
        /// <exception cref="ArgumentNullException">The required parameter <paramref name="paymentLinkCreate"/> is null.</exception>
        ...
        public  Task<PaymentLink> CreateAsync(PaymentLinkCreate paymentLinkCreate, string? merchantAccountId = null);
        ...
        /// </remarks>
        /// <param name="paymentLinkId">The unique identifier for the payment link.</param>
        /// <param name="merchantAccountId">The ID of the merchant account to use for this request.</param>
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task ExpireAsync(string paymentLinkId, string? merchantAccountId = null);
    ...
    public class PaymentLinks: IPaymentLinks
    {
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<PaymentLink> CreateAsync(
        ...
        )
        {
            ...
            var serializedBody = RequestBodySerializer.Serialize(request, "PaymentLinkCreate", "json", false, false);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "add_payment_link", null, SDKConfiguration.SecuritySource);
        ...
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "list_payment_links", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var httpResponseBody = await httpResponse.Content.ReadAsStringAsync();
                    Models.Components.PaymentLinks obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<Models.Components.PaymentLinks>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into Models.Components.PaymentLinks.", httpResponse, httpResponseBody, ex);
                    }
        ...
        public async  Task ExpireAsync(string paymentLinkId, string? merchantAccountId = null)
        {
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/payment-links/{payment_link_id}/expire", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "expire_payment_link", null, SDKConfiguration.SecuritySource);
        ...
        )
        {
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/payment-links/{payment_link_id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "get_payment_link", null, SDKConfiguration.SecuritySource);
