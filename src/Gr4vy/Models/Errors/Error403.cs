...
namespace Gr4vy.Models.Errors
{
    ...
    public class Error403Payload
    {
        ...
        public long? Status { get; set; } = 403;
    ...
    public class Error403 : BaseException
    {
        /// <summary>
        ...
        [Obsolete("This field will be removed in a future release, please migrate away from it as soon as possible. Use Error403.Payload.Type instead.")]
        ...
        [Obsolete("This field will be removed in a future release, please migrate away from it as soon as possible. Use Error403.Payload.Status instead.")]
        ...
        [Obsolete("This field will be removed in a future release, please migrate away from it as soon as possible. Use Error403.Payload.Details instead.")]
        public List<ErrorDetail>? Details { get; set; }

        private static string ErrorMessage(Error403Payload payload, string body)
        {
