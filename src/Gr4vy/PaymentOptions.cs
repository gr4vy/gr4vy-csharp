...
namespace Gr4vy
{
    ...
    public interface IPaymentOptions
    {
        ...
        /// </remarks>
        /// <param name="paymentOptionRequest">A <see cref="PaymentOptionRequest"/> parameter.</param>
        /// <param name="merchantAccountId">The ID of the merchant account to use for this request.</param>
        /// <returns>An awaitable task that returns a <see cref="Models.Components.PaymentOptions"/> object when completed.</returns>
        /// <exception cref="ArgumentNullException">The required parameter <paramref name="paymentOptionRequest"/> is null.</exception>
        ...
        public  Task<Models.Components.PaymentOptions> ListAsync(
    ...
    public class PaymentOptions: IPaymentOptions
    {
        ...
        public PaymentOptions(SDKConfig config)
        {
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<Models.Components.PaymentOptions> ListAsync(
            PaymentOptionRequest paymentOptionRequest,
            string? merchantAccountId = null
        )
        {
            ...
            var serializedBody = RequestBodySerializer.Serialize(request, "PaymentOptionRequest", "json", false, false);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "list_payment_options", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    Models.Components.PaymentOptions obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<Models.Components.PaymentOptions>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into Models.Components.PaymentOptions.", httpResponse, httpResponseBody, ex);
                    }
