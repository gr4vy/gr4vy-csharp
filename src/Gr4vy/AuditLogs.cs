...
namespace Gr4vy
{
    ...
    public interface IAuditLogs
    {
        ...
        /// </remarks>
        /// <param name="request">A <see cref="ListAuditLogsRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="ListAuditLogsResponse"/> object when completed.</returns>
        ...
        public  Task<ListAuditLogsResponse> ListAsync(
    ...
    public class AuditLogs: IAuditLogs
    {
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<ListAuditLogsResponse> ListAsync(
            ListAuditLogsRequest? request = null,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/audit-logs", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "list_audit_logs", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<AuditLogEntries>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into AuditLogEntries.", httpResponse, httpResponseBody, ex);
                    }
