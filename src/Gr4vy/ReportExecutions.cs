...
namespace Gr4vy
{
    ...
    public interface IReportExecutions
    {
        ...
        /// </remarks>
        /// <param name="request">A <see cref="ListAllReportExecutionsRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="ListAllReportExecutionsResponse"/> object when completed.</returns>
        ...
        public  Task<ListAllReportExecutionsResponse> ListAsync(
            ListAllReportExecutionsRequest? request = null,
    ...
    public class ReportExecutions: IReportExecutions
    {
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<ListAllReportExecutionsResponse> ListAsync(
            ListAllReportExecutionsRequest? request = null,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/report-executions", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "list_all_report_executions", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<Models.Components.ReportExecutions>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
