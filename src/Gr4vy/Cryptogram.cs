...
namespace Gr4vy
{
    ...
    public interface ICryptogram
    {
        ...
        /// <param name="cryptogramCreate">A <see cref="CryptogramCreate"/> parameter.</param>
        /// <param name="merchantAccountId">The ID of the merchant account to use for this request.</param>
        /// <returns>An awaitable task that returns a <see cref="Models.Components.Cryptogram"/> object when completed.</returns>
        /// <exception cref="ArgumentNullException">One of <paramref name="paymentMethodId"/>, <paramref name="networkTokenId"/> or <paramref name="cryptogramCreate"/> is null.</exception>
        ...
        public  Task<Models.Components.Cryptogram> CreateAsync(
    ...
    public class Cryptogram: ICryptogram
    {
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<Models.Components.Cryptogram> CreateAsync(
            string paymentMethodId,
            string networkTokenId,
            CryptogramCreate cryptogramCreate,
            string? merchantAccountId = null
        )
        {
            ...
            var serializedBody = RequestBodySerializer.Serialize(request, "CryptogramCreate", "json", false, false);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "create_payment_method_network_token_cryptogram", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 201)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    Models.Components.Cryptogram obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<Models.Components.Cryptogram>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into Models.Components.Cryptogram.", httpResponse, httpResponseBody, ex);
                    }
