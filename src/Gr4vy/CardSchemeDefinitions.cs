...
namespace Gr4vy
{
    ...
    public interface ICardSchemeDefinitions
    {
        ...
        /// <returns>An awaitable task that returns a <see cref="Models.Components.CardSchemeDefinitions"/> object when completed.</returns>
        ...
        public  Task<Models.Components.CardSchemeDefinitions> ListAsync(
    ...
    public class CardSchemeDefinitions: ICardSchemeDefinitions
    {
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<Models.Components.CardSchemeDefinitions> ListAsync(
            string? merchantAccountId = null,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "list_card_scheme_definitions", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    Models.Components.CardSchemeDefinitions obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<Models.Components.CardSchemeDefinitions>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into Models.Components.CardSchemeDefinitions.", httpResponse, httpResponseBody, ex);
                    }
