...
namespace Gr4vy
{
    ...
    public interface IExecutions
    {
        ...
        /// </remarks>
        /// </summary>
        Task<ListAllReportExecutionsResponse> AllAsync(ListAllReportExecutionsRequest? request = null, RetryConfig? retryConfig = null);
    ...
    public class Executions: IExecutions
    {
        ...
        public async Task<ListReportExecutionsResponse> ListAsync(string reportId, string? cursor = null, long? limit = 20, string? merchantAccountId = null, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<ReportExecutions>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
                    var result = obj!;
        ...
        public async Task<ListAllReportExecutionsResponse> AllAsync(ListAllReportExecutionsRequest? request = null, RetryConfig? retryConfig = null)
        {
            request.MerchantAccountId ??= SDKConfiguration.MerchantAccountId;
