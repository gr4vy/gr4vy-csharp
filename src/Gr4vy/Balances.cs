...
namespace Gr4vy
{
    ...
    public interface IBalances
    {
        ...
        /// </remarks>
        /// </summary>
        Task<CollectionNoCursorGiftCardSummary> ListAsync(GiftCardBalanceRequest giftCardBalanceRequest, double? timeoutInSeconds = 1D, string? merchantAccountId = null);
    }
    ...
    public class Balances: IBalances
    {
        ...
        public async Task<CollectionNoCursorGiftCardSummary> ListAsync(GiftCardBalanceRequest giftCardBalanceRequest, double? timeoutInSeconds = 1D, string? merchantAccountId = null)
        {
