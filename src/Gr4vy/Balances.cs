...
namespace Gr4vy
{
    ...
    public interface IBalances
    {
        ...
        /// </remarks>
        /// <param name="giftCardBalanceRequest">A <see cref="GiftCardBalanceRequest"/> parameter.</param>
        ...
        /// <exception cref="ArgumentNullException">The required parameter <paramref name="giftCardBalanceRequest"/> is null.</exception>
    ...
    public class Balances: IBalances
    {
        ...
        )
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "list_gift_card_balances", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<GiftCardSummaries>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into GiftCardSummaries.", httpResponse, httpResponseBody, ex);
                    }
