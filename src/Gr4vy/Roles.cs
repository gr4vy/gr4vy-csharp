...
namespace Gr4vy
{
    ...
    public interface IRoles
    {
        ...
        /// <returns>An awaitable task that returns a <see cref="ListRolesResponse"/> object when completed.</returns>
        ...
        public  Task<ListRolesResponse> ListAsync(
            string? cursor = null,
            long? limit = 20,
    ...
    public class Roles: IRoles
    {
        ...
        )
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/roles", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "list_roles", null, SDKConfiguration.SecuritySource);
            ...
            Func<Task<ListRolesResponse?>> nextFunc = async delegate()
            {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<CollectionRole>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into CollectionRole.", httpResponse, httpResponseBody, ex);
                    }
