...
namespace Gr4vy
{
    ...
    public interface IActivations
    {
        ...
        /// <exception cref="ArgumentNullException">The required parameter <paramref name="giftCardActivationCreate"/> is null.</exception>
        ...
        public  Task<GiftCard> CreateAsync(
    ...
    public class Activations: IActivations
    {
        /// <summary>
        /// SDK Configuration.
        /// <see cref="SDKConfig"/>
        ...
        public Activations(SDKConfig config)
        {
        ...
        /// <exception cref="Error504">The server encountered an error. Thrown when the API returns a 504 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<GiftCard> CreateAsync(
            GiftCardActivationCreate giftCardActivationCreate,
            string? idempotencyKey = null,
            string? merchantAccountId = null
        )
        {
            if (giftCardActivationCreate == null) throw new ArgumentNullException(nameof(giftCardActivationCreate));

            var request = new ActivateGiftCardRequest()
            {
                GiftCardActivationCreate = giftCardActivationCreate,
            ...
            var urlString = baseUrl + "/gift-cards/activations";
            ...
            var serializedBody = RequestBodySerializer.Serialize(request, "GiftCardActivationCreate", "json", false, false);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "activate_gift_card", null, SDKConfiguration.SecuritySource);
