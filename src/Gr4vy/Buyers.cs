...
namespace Gr4vy
{
    ...
    public class Buyers: IBuyers
    {
        ...
        public async Task<ListBuyersResponse> ListAsync(ListBuyersRequest? request = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "list_buyers", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task<Buyer> CreateAsync(BuyerCreate buyerCreate, string? merchantAccountId = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "add_buyer", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task<Buyer> GetAsync(string buyerId, string? merchantAccountId = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "get_buyer", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task<Buyer> UpdateAsync(string buyerId, BuyerUpdate buyerUpdate, string? merchantAccountId = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "update_buyer", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task DeleteAsync(string buyerId, string? merchantAccountId = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "delete_buyer", new List<string> {  }, SDKConfiguration.SecuritySource);
