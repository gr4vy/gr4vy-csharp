...
namespace gr4vy
{
    ...
    public interface IRefunds
    {
        ...
        /// </remarks>
        /// </summary>
        Task<GetRefundResponse> GetAsync(string refundId, string? merchantAccountId = null, RetryConfig? retryConfig = null);
    }
    ...
    public class Refunds: IRefunds
    {
        ...
        public Refunds(ISpeakeasyHttpClient client, Func<gr4vy.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<GetRefundResponse> GetAsync(string refundId, string? merchantAccountId = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "get_refund", new List<string> {  }, _securitySource);
            ...
            else if(responseStatusCode == 403)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<Response403GetRefund>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
