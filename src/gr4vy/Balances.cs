...
namespace gr4vy
{
    ...
    public interface IBalances
    {
        ...
        /// </remarks>
        /// </summary>
        Task<ListGiftCardBalancesResponse> ListAsync(GiftCardBalanceRequest giftCardBalanceRequest, double? timeoutInSeconds = 1D, string? merchantAccountId = null);
    }
    ...
    public class Balances: IBalances
    {
        ...
        public Balances(ISpeakeasyHttpClient client, Func<gr4vy.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<ListGiftCardBalancesResponse> ListAsync(GiftCardBalanceRequest giftCardBalanceRequest, double? timeoutInSeconds = 1D, string? merchantAccountId = null)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "list_gift_card_balances", new List<string> {  }, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new ListGiftCardBalancesResponse()
                    {
            ...
            else if(responseStatusCode == 403)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<Response403ListGiftCardBalances>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
