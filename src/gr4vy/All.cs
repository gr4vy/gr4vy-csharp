...
namespace gr4vy
{
    ...
    public interface IAll
    {
        ...
        /// </remarks>
        /// </summary>
        Task<CreateFullTransactionRefundResponse> CreateAsync(string transactionId, double? timeoutInSeconds = 1D, string? merchantAccountId = null, TransactionRefundAllCreate? transactionRefundAllCreate = null);
    }
    ...
    public class All: IAll
    {
        ...
        public async Task<CreateFullTransactionRefundResponse> CreateAsync(string transactionId, double? timeoutInSeconds = 1D, string? merchantAccountId = null, TransactionRefundAllCreate? transactionRefundAllCreate = null)
        {
            ...
            if(responseStatusCode == 201)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new CreateFullTransactionRefundResponse()
                    {
                    ...
                    response.CollectionNoCursorRefund = obj;
                    return response;
                }
