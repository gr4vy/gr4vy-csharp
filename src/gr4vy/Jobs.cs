...
namespace gr4vy
{
    ...
    public interface IJobs
    {
        ...
        /// </remarks>
        /// </summary>
        Task<CreateAccountUpdaterJobResponse> CreateAsync(AccountUpdaterJobCreate accountUpdaterJobCreate, double? timeoutInSeconds = 1D, string? merchantAccountId = null);
    }
    ...
    public class Jobs: IJobs
    {
        ...
        public Jobs(ISpeakeasyHttpClient client, Func<gr4vy.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<CreateAccountUpdaterJobResponse> CreateAsync(AccountUpdaterJobCreate accountUpdaterJobCreate, double? timeoutInSeconds = 1D, string? merchantAccountId = null)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "create_account_updater_job", new List<string> {  }, _securitySource);
            ...
            if(responseStatusCode == 201)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<AccountUpdaterJob>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
                    var response = new CreateAccountUpdaterJobResponse()
                    {
                    ...
                    response.AccountUpdaterJob = obj;
                    return response;
                }
            ...
            else if(responseStatusCode == 403)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<Response403CreateAccountUpdaterJob>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
