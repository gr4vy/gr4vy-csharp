...
namespace gr4vy
{
    ...
    public interface IPaymentServiceDefinitions
    {
        ...
        /// </remarks>
        /// </summary>
        Task<GetPaymentServiceDefinitionResponse> GetAsync(string paymentServiceDefinitionId, RetryConfig? retryConfig = null);
        ...
        /// </remarks>
        /// </summary>
        Task<CreatePaymentServiceDefinitionSessionResponse> SessionAsync(string paymentServiceDefinitionId, Dictionary<string, object> requestBody);
    }
    ...
    public class PaymentServiceDefinitions: IPaymentServiceDefinitions
    {
        ...
        public PaymentServiceDefinitions(ISpeakeasyHttpClient client, Func<gr4vy.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<ListPaymentServiceDefinitionsResponse> ListAsync(string? cursor = null, long? limit = 20, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "list_payment_service_definitions", new List<string> {  }, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<CollectionPaymentServiceDefinition>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Include);
                    ...
                    response.CollectionPaymentServiceDefinition = obj;
                    return response;
                }
            ...
            else if(responseStatusCode == 403)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<Response403ListPaymentServiceDefinitions>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Include);
        ...
        public async Task<GetPaymentServiceDefinitionResponse> GetAsync(string paymentServiceDefinitionId, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "get_payment_service_definition", new List<string> {  }, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new GetPaymentServiceDefinitionResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
                    ...
                    response.PaymentServiceDefinition = obj;
                    return response;
                }
            ...
            else if(responseStatusCode == 403)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<Response403GetPaymentServiceDefinition>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
                    var httpMeta = new Models.Components.HTTPMetadata()
                    {
                        Response = httpResponse,
                        Request = httpRequest
        ...
        public async Task<CreatePaymentServiceDefinitionSessionResponse> SessionAsync(string paymentServiceDefinitionId, Dictionary<string, object> requestBody)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "create_payment_service_definition_session", new List<string> {  }, _securitySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new CreatePaymentServiceDefinitionSessionResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
            ...
            else if(responseStatusCode == 403)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<Response403CreatePaymentServiceDefinitionSession>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
                    var httpMeta = new Models.Components.HTTPMetadata()
                    {
                        Response = httpResponse,
                        Request = httpRequest
