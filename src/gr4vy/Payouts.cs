...
namespace gr4vy
{
    ...
    public interface IPayouts
    {
        ...
        /// </remarks>
        /// </summary>
        Task<CreatePayoutResponse> CreateAsync(PayoutCreate payoutCreate, double? timeoutInSeconds = 1D, string? merchantAccountId = null);
        ...
        /// </remarks>
        /// </summary>
        Task<GetPayoutResponse> GetAsync(string payoutId, string? merchantAccountId = null, RetryConfig? retryConfig = null);
    }
    ...
    public class Payouts: IPayouts
    {
        ...
        public async Task<ListPayoutsResponse> ListAsync(string? cursor = null, long? limit = 20, string? merchantAccountId = null, RetryConfig? retryConfig = null)
        {
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    response.CollectionPayoutSummary = obj;
                    return response;
                }
            ...
            else if(responseStatusCode == 403)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<Response403ListPayouts>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Include);
        ...
        public async Task<CreatePayoutResponse> CreateAsync(PayoutCreate payoutCreate, double? timeoutInSeconds = 1D, string? merchantAccountId = null)
        {
            ...
            else if(responseStatusCode == 403)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<Response403CreatePayout>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
                    var httpMeta = new Models.Components.HTTPMetadata()
                    {
                        Response = httpResponse,
                        Request = httpRequest
        ...
        public async Task<GetPayoutResponse> GetAsync(string payoutId, string? merchantAccountId = null, RetryConfig? retryConfig = null)
        {
            ...
            else if(responseStatusCode == 403)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<Response403GetPayout>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
                    var httpMeta = new Models.Components.HTTPMetadata()
                    {
                        Response = httpResponse,
                        Request = httpRequest
